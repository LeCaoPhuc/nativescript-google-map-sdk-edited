...
var Polyline = (function (_super) {
    ...
    Object.defineProperty(Polyline.prototype, "jointtype", {
        get: function () {
            return this._android.getJointType();
        },
        set: function (value) {
            if (this._isReal) {
                this._android.setJointType(value);
            }
            else {
                this._android.jointType(value);
            }
        },
        enumerable: true,
        configurable: true
...
var Polygon = (function (_super) {
    ...
    Object.defineProperty(Polygon.prototype, "strokeJointType", {
        get: function () {
            return this._strokeColor;
        },
        set: function (value) {
            this._strokeColor =getStrokeJointType(value);
            if (this._isReal) {
                this._android.setStrokeJointType(value);
            }
            else {
                this._android.strokeJointType(value);
            }
        },
        enumerable: true,
        configurable: true
